            ...
            <div className="section">
                <div className="section-container">
                    ...
                    <div className="section-imgWrapper">
                      ...
                      <div className={video==="video-tv.m4v"?"sectionAnimation-container tvVideo":"sectionAnimation-container itemsVideo"}>
        ...
        return(
            <div className="section">
                <div className="section-container section1">
                    <div className="section-imgWrapper">
                      <img src={`./Images/${image}`} alt="error"></img>
                      <div className="phoneAnimation" style={{display:id==1?"flex":"none"}}>
