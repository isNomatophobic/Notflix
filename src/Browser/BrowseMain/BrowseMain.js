...
function BrowseMain({accounts}) {
    ...
    const currentImage = location.state ? location.state.currentImage : '107 - LJ9dB0T'
    ...
    const [isLoading,setLoading] = useState(true)
        ...
        <BrowseMainHeader  accounts={accounts} setLoading={setLoading} currentUser={currentUser} setCurrentUser={setCurrentUser} />
        <BrowseMainSections setCurrentHovered={setCurrentHovered}/>
        <BrowseMainPreview currentHovered={currentHovered}/>
        </div>
        :null}
            <div className="loadingScreen" style={{display:isLoading?"block":"none"}}>
