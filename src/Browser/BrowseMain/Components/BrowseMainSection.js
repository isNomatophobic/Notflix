...
export default function BrowseMainSections({sectionTitle,keyword,setCurrentHovered}) {
        ...
        const fetchMovies = async()=>{
            ...
            const jsxArray = movies.map((movie,i=0)=>{
                ...
                console.log(url);
                return <BrowseMainSectionMovie url={url} vote={movie.vote_average} id={movie.id} setCurrentHovered={setCurrentHovered}/>
            })
        ...
        return (
            <div className="browseMain-Section">
                ...
                <div className="section-MoviesContainer">
                        <div ref={moviesContainer} className="movies" style={{transform:`translate3d(${slidePosition}%, 0px, 0px)`}}>
                            {sectionMovies}
                        </div>
                    <div className="section-Arrow section-ArrowRight" onClick={(e)=>slide(e)}>
                        <Arrow/>
                    </div>
                    <div className="section-Arrow section-ArrowLeft" onClick={(e)=>slide(e)} style={{display:hasSlided?"flex":"none"}} >
                        <Arrow/>
                    </div>
                </div>
            </div>
