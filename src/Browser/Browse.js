  ...
  return (
    <Switch>
      ...
      <Route path={`/browse/createProfile`}>
        {isLoading?<></>:<CreateProfile accounts={accounts} setAccounts={setAccounts}/>}
      </Route>
      <Route path={`/browse/manageProfile`}>
        {isLoading?<></>:<ManageProfile accounts={accounts} setAccounts={setAccounts}/>}
      </Route>
      <Route>
        {isLoading?<></>:<BrowseMain accounts={accounts}/>}
      </Route>
    </Switch>
  );
}
